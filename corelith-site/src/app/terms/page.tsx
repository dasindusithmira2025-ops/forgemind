    ...
    <>
      ...
      <Band tone="ground">
        <div className="shell mb-12">
          {/* The graticule under the opening: seven clause groups, so seven
              ticks — the page's length stated before it is read. */}
          <ul className="ticks reveal" aria-hidden="true" style={{ "--d": "80ms" } as CSSProperties}>
