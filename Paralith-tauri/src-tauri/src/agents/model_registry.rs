...
const MODELS: &[RegisteredModel] = &[
    RegisteredModel {
        ...
        model_id: "opus",
        display_name: "Opus",
        description: "Deep planning and architecture work.",
        reasoning: &["low", "medium", "high", "max"],
        modes: &["interactive", "autonomous", "review"],
        recommended_roles: &["coordinator", "scout"],
        vision: true,
    },
    RegisteredModel {
        provider_id: "claude",
        ...
        model_id: "fable",
        display_name: "Fable",
        description: "Broad analysis and exploratory engineering.",
        reasoning: &["low", "medium", "high"],
        modes: &["interactive", "autonomous", "review"],
        recommended_roles: &["scout", "reviewer"],
        vision: true,
    },
    RegisteredModel {
        provider_id: "claude",
        ...
        model_id: "sonnet",
        display_name: "Sonnet",
        description: "Balanced coding, review, and implementation.",
        reasoning: &["low", "medium", "high"],
        modes: &["interactive", "autonomous", "review"],
        recommended_roles: &["builder", "reviewer", "debugger"],
        vision: true,
    },
    RegisteredModel {
        provider_id: "codex",
        ...
        description: "Strong general coding and repository work.",
        reasoning: &["low", "medium", "high", "max"],
        modes: &["interactive", "autonomous", "review"],
    ...
    RegisteredModel {
        ...
        model_id: "sol",
        display_name: "SOL",
        description: "Deep reasoning and complex implementation.",
        reasoning: &["medium", "high", "max"],
        modes: &["interactive", "autonomous", "review"],
        recommended_roles: &["builder", "debugger", "coordinator"],
        vision: true,
    },
    RegisteredModel {
        provider_id: "codex",
        ...
        model_id: "luna",
        display_name: "Luna",
        description: "Fast iteration and lightweight tasks.",
        reasoning: &["low", "medium"],
        modes: &["interactive", "autonomous"],
        recommended_roles: &["builder", "debugger"],
        vision: false,
    },
    RegisteredModel {
        provider_id: "codex",
        ...
        model_id: "terra",
        display_name: "Terra",
        description: "Review, validation, and broad codebase analysis.",
        reasoning: &["medium", "high", "max"],
        modes: &["interactive", "autonomous", "review"],
        recommended_roles: &["reviewer", "scout", "debugger"],
        vision: true,
    },
];
...
pub fn default_for(provider_id: &str) -> Option<SwarmMemberModelConfig> {
    ...
    Some(SwarmMemberModelConfig::configured(
        model.provider_id,
        model.model_id,
        model.provider_name,
        model.display_name,
...
pub fn capability(
    ...
    SwarmModelCapability {
        ...
        provider_display_name: model.provider_name.into(),
        ...
        recommended_roles: model
            .recommended_roles
            .iter()
            .map(|v| (*v).into())
            .collect(),
        authenticated: provider_available,
