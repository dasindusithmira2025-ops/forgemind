...
export function WorkspaceScreen() {
  ...
  >
    <AgentModeSurface visible={productMode === 'agent'} project={project} workspace={workspace} onOpenCode={(targetWorkspaceId) => { setProductMode('code'); if (targetWorkspaceId && targetWorkspaceId !== workspace.id) navigate(`/workspace/${targetWorkspaceId}`) }} />
