...
describe('parseRemoteProjection', () => {
  ...
  it('maps GitHub workflow definitions, paginated run payload fields and rich pull request data', () => {
    ...
    expect(views.pullRequests[0]).toMatchObject({ number: 4, baseBranch: 'main', headBranch: 'feat/source-control', changedFiles: 52, commits: 2, checksState: 'passing' })
  })
