...
export const native = {
  ...
  createAgentConversation: (agentId: string, title: string) => invoke<AgentConversation>('create_agent_conversation', { agentId, title }),
  ...
  searchAgentHistory: (agentId: string, query: string) => invoke<AgentConversationEntry[]>('search_agent_history', { agentId, query }),
